...
@Component({
    ...
    template: `
        <div class="flex flex-col">
            <div class="card">
                <div class="font-semibold text-xl mb-6">Toolbar</div>
                <p-toolbar>
                    <ng-template #start>
            ...
            <div class="flex flex-col md:flex-row gap-20">
                <div class="md:w-1/2">
                    <div class="card">
                        <div class="font-semibold text-xl mb-6">Accordion</div>
                        <p-accordion value="0">
                    ...
                    <div class="card">
                        <div class="font-semibold text-xl mb-6">Tabs</div>
                        <p-tabs value="0">
                            <p-tablist>
                ...
                <div class="md:w-1/2 mt-12 md:mt-0">
                    <div class="card">
                        <div class="font-semibold text-xl mb-6">Panel</div>
                    ...
                    <div class="card">
                        <div class="font-semibold text-xl mb-6">Fieldset</div>
            ...
            <div class="card mt-20">
                <div class="font-semibold text-xl mb-6">Divider</div>
            ...
            <div class="card">
                <div class="font-semibold text-xl mb-6">Splitter</div>
