...
@Component({
    ...
    template: `
        <div class="card">
            <div class="font-semibold text-xl mb-6">ProgressBar</div>
        ...
        <div class="flex flex-col md:flex-row gap-20">
            <div class="md:w-1/2">
                <div class="card">
                    <div class="font-semibold text-xl mb-6">Badge</div>
                    ...
                    <div class="font-semibold my-6">Overlay</div>
                    ...
                    <div class="font-semibold my-6">Button</div>
                    <div class="flex gap-2">
                    ...
                    <div class="font-semibold my-6">Sizes</div>
                ...
                <div class="card">
                    <div class="font-semibold text-xl mb-6">Avatar</div>
                    <div class="font-semibold mb-6">Group</div>
                    <p-avatargroup styleClass="mb-6">
                    ...
                    <div class="font-semibold my-6">Label - Circle</div>
                    ...
                    <div class="font-semibold my-6">Icon - Badge</div>
                ...
                <div class="card">
                    <div class="font-semibold text-xl mb-6">Skeleton</div>
            ...
            <div class="md:w-1/2">
                <div class="card">
                    <div class="font-semibold text-xl mb-6">Tag</div>
                    <div class="font-semibold mb-6">Default</div>
                    <div class="flex gap-2">
                    ...
                    <div class="font-semibold my-6">Pills</div>
                    <div class="flex gap-2">
                    ...
                    <div class="font-semibold my-6">Icons</div>
                    <div class="flex gap-2">
                ...
                <div class="card">
                    <div class="font-semibold text-xl mb-6">Chip</div>
                    <div class="font-semibold mb-6">Basic</div>
                    ...
                    <div class="font-semibold my-6">Icon</div>
                    <div class="flex items-center flex-col sm:flex-row">
                    ...
                    <div class="font-semibold my-6">Image</div>
                    <div class="flex items-center flex-col sm:flex-row">
