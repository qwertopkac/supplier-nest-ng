...
import { Customer, Representative } from '../../core/models/domain/customer';
...
@Component({
    ...
    template: ` <div class="card">
            <div class="font-semibold text-xl mb-6">Filtering</div>
            <p-table
                #dt1
                [value]="customers1"
                dataKey="id"
        ...
        <div class="card">
            <div class="font-semibold text-xl mb-6">Frozen Columns</div>
            <p-togglebutton [(ngModel)]="balanceFrozen" [onIcon]="'pi pi-lock'" offIcon="pi pi-lock-open" [onLabel]="'Balance'" offLabel="Balance" />

            <p-table [value]="customers2" [scrollable]="true" scrollHeight="400px" styleClass="mt-6">
                <ng-template #header>
                    <tr>
        ...
        <div class="card">
            <div class="font-semibold text-xl mb-6">Row Expansion</div>
        ...
        <div class="card">
            <div class="font-semibold text-xl mb-6">Grouping</div>
