...
@Component({
    ...
    template: `
        <div class="card">
            <div class="font-semibold text-xl mb-6">Menubar</div>
        ...
        <div class="card">
            <div class="font-semibold text-xl mb-6">Breadcrumb</div>
        ...
        <div class="flex flex-col md:flex-row gap-20">
            <div class="md:w-1/2">
                <div class="card">
                    <div class="font-semibold text-xl mb-6">Steps</div>
                    <p-stepper [value]="1">
                        <p-step-list>
            ...
            <div class="md:w-1/2">
                <div class="card">
                    <div class="font-semibold text-xl mb-6">TabMenu</div>
                    <p-tabs [value]="0">
                        <p-tablist>
        ...
        <div class="flex flex-col md:flex-row gap-20 mt-12">
            <div class="md:w-1/3">
                <div class="card">
                    <div class="font-semibold text-xl mb-6">Tiered Menu</div>
                    <p-tieredmenu [model]="tieredMenuItems"></p-tieredmenu>
                </div>
            </div>
            <div class="md:w-1/3">
                <div class="card">
                    <div class="font-semibold text-xl mb-6">Plain Menu</div>
                    <p-menu [model]="menuItems"></p-menu>
                </div>
            </div>
            <div class="md:w-1/3">
                <div class="card">
                    <div class="font-semibold text-xl mb-6">Overlay Menu</div>
                ...
                <div class="card" #anchor>
                    <div class="font-semibold text-xl mb-6">Context Menu</div>
        ...
        <div class="flex flex-col md:flex-row gap-20 mt-20">
            <div class="md:w-1/2">
                <div class="card">
                    <div class="font-semibold text-xl mb-6">MegaMenu | Horizontal</div>
                    <p-megamenu [model]="megaMenuItems" />

                    <div class="font-semibold text-xl mb-6 mt-20">MegaMenu | Vertical</div>
                    <p-megamenu [model]="megaMenuItems" orientation="vertical" />
                </div>
            </div>
            <div class="md:w-1/2">
                <div class="card">
                    <div class="font-semibold text-xl mb-6">PanelMenu</div>
