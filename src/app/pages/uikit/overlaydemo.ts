...
@Component({
    ...
    template: ` <div class="flex flex-col md:flex-row gap-20">
        <div class="md:w-1/2">
            <div class="card">
                <div class="font-semibold text-xl mb-6">Dialog</div>
            ...
            <div class="card">
                <div class="font-semibold text-xl mb-6">Popover</div>
            ...
            <div class="card">
                <div class="font-semibold text-xl mb-6">Tooltip</div>
        ...
        <div class="md:w-1/2">
            <div class="card">
                <div class="font-semibold text-xl mb-6">Drawer</div>
            ...
            <div class="card">
                <div class="font-semibold text-xl mb-6">ConfirmPopup</div>
                <p-confirmpopup></p-confirmpopup>
                <p-button #popup (click)="confirm($event)" icon="pi pi-check" label="Confirm" class="mr-2"></p-button>
            </div>

            <div class="card">
                <div class="font-semibold text-xl mb-6">ConfirmDialog</div>
