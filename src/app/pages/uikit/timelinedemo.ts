...
@Component({
    ...
    template: ` <div class="grid grid-cols-12 gap-4 grid-cols-12 gap-20">
        <div class="col-span-6">
            <div class="card">
                <div class="font-semibold text-xl mb-6">Left Align</div>
        ...
        <div class="col-span-6">
            <div class="card">
                <div class="font-semibold text-xl mb-6">Right Align</div>
        ...
        <div class="col-span-6">
            <div class="card">
                <div class="font-semibold text-xl mb-6">Alternate Align</div>
        ...
        <div class="col-span-6">
            <div class="card">
                <div class="font-semibold text-xl mb-6">Opposite Content</div>
                <p-timeline [value]="events1">
                    <ng-template #content let-event>
        ...
        <div class="col-span-full">
            <div class="card">
                <div class="font-semibold text-xl mb-6">Templating</div>
                <p-timeline [value]="events1" align="alternate" styleClass="customized-timeline">
                    <ng-template #marker let-event>
                        <span class="flex w-8/12 h-8 items-center justify-center text-white rounded-full z-10 shadow-sm" [style]="{ 'background-color': event.color }">
        ...
        <div class="col-span-full">
            <div class="card">
                <div class="font-semibold text-xl mb-6">Horizontal</div>
                ...
                <div class="font-semibold mt-6 mb-2">Bottom Align</div>
                ...
                <div class="font-semibold mt-6 mb-2">Alternate Align</div>
