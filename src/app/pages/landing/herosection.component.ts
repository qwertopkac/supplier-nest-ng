    ...
    template: `
        <section class="landing-hero   ">
            <div class="flex flex-col items-center">
                ...
                <div class="bg-surface-0 border border-black/10 dark:border-white/20 dark:bg-surface-950 w-full rounded-3xl p-0 flex lg:hidden items-start gap-12 overflow-hidden">
                ...
                <div class="bg-surface-0 border border-black/10 dark:border-white/20 dark:bg-surface-950 w-full h-[85vh] max-h-[1040px] rounded-3xl p-12 hidden lg:flex lg:mt-20 items-start gap-12 overflow-hidden">
                    <div
                        [ngClass]="{
                            'w-auto': isSlimMenu,
                            'w-72': !isSlimMenu
                    ...
                    >
                        ...
                        >
                            <div class="flex items-center gap-4">
                                <div class="w-11/12 h-11 border border-primary rounded-xl flex items-center justify-center">
                                ...
                                <div
                                    *ngFor="let navItem of sampleAppsSidebarNavsMore"
                                    ...
                                    [ngClass]="{
                                        ...
                                        'w-full': !isSlimMenu,
                                        'text-muted-color hover:bg-emphasis bg-transparent': selectedSampleAppsSidebarNav !== navItem.title,
                                        ' bg-primary text-primary-contrast hover:bg-primary-emphasis': selectedSampleAppsSidebarNav === navItem.title
                                    }"
                                >
                                    <i [class]="navItem.icon"></i>
                                    <span [class]="isSlimMenu ? 'hidden' : 'font-medium leading-8'">・</span>
            ...
            <p-drawer [(visible)]="dashboardSidebarVisible" position="right" closeIcon="pi pi-sign-out" styleClass="!max-w-2xl !w-full !h-screen rounded-l-2xl">
                <ng-template #headless>
                    <div class="flex flex-col h-screen overflow-auto">
                        ...
                        <div *ngIf="selectedSidebarOption === 'Opportunities'" class="grid grid-cols-2 gap-12 p-12">
