        ...
        <div class="mt-12 flex flex-wrap items-start gap-12">
            <div class="flex-1 flex flex-col gap-12">
                    ...
                    <div class="flex flex-col gap-6">
                        <div class="p-2 rounded-2xl flex items-center gap-4 bg-emphasis">
                            <p-overlayBadge severity="danger" class="w-fit">
                                <p-avatar image="https://www.primefaces.org/cdn/primevue/images/landing/apps/main-avatar.png" class="rounded-lg overflow-hidden w-10/12 h-10 block" />
                            </p-overlayBadge>
                        ...
                        <div class="p-2 rounded-2xl flex items-center gap-4 bg-emphasis">
                            <p-overlayBadge severity="danger" class="w-fit">
                                <p-avatar image="https://www.primefaces.org/cdn/primevue/images/landing/apps/avatar9.jpg" class="rounded-lg overflow-hidden w-10/12 h-10 flex" />
                            </p-overlayBadge>
                ...
                <div class="border border-surface rounded-3xl p-12">
                    <div class="flex items-center gap-4 p-4 border border-surface rounded-xl shadow-[0px_1px_2px_0px_rgba(18,18,23,0.05)]">
                ...
                <div class="border border-surface rounded-3xl">
                    ...
                    <div class="p-1 mt-6">
                        <button class="p-6 rounded-3xl w-full bg-emphasis transition-all text-color hover:text-color-emphasis flex items-center gap-2 justify-between cursor-pointer">
                    ...
                    <div>
                        ...
                        <p-fileupload name="demo[]" url="/api/upload" (onUpload)="onTemplatedUpload($event)" accept="image/*" [maxFileSize]="1000000" styleClass="mt-2" (onSelect)="onSelectedFiles($event)">
                            <ng-template #header let-chooseCallback="chooseCallback" let-clearCallback="clearCallback" let-uploadCallback="uploadCallback">
                                <div *ngIf="files.length > 0 || uploadedFiles.length > 0" class="flex w-full flex-wrap justify-between items-center flex-1 gap-6 border-b border-surface pb-6">
                                ...
                                <div *ngIf="files.length <= 0 && uploadedFiles.length <= 0" class="flex flex-col items-center justify-center p-12 cursor-pointer" (click)="chooseCallback()">
                            ...
                            <ng-template #content let-chooseCallback="chooseCallback" let-clearCallback="clearCallback" let-uploadCallback="uploadCallback" let-removeCallback="removeCallback">
                                <div *ngIf="files.length > 0" class="px-6 py-0">
                                    ...
                                    <div class="flex flex-wrap gap-2 grow overflow-auto max-h-[210px]">
                                        <div *ngFor="let file of files; let i = index" class="card max-w-[120px] !p-2 m-0 flex flex-col border border-surface items-center gap-2 text-center">
                                            <div>
                                ...
                                <div *ngIf="uploadedFiles.length > 0" class="px-6 py-0">
                                    ...
                                    <div class="flex flex-wrap gap-2">
                                        <div *ngFor="let file of uploadedFiles" :key="file.name + file.type + file.size" class="card max-w-[120px] !p-2 m-0 flex flex-col border border-surface items-center gap-2 text-center">
                                            <div>
                                                <img role="presentation" [alt]="file.name" :src="file.objectURL" width="100" height="50" />
                                            </div>
                                            <span class="font-semibold max-w-[100px] text-ellipsis whitespace-nowrap overflow-hidden">{{ file.name }}</span>
                    ...
                    <div>
                        ...
                        <div class="mt-6 flex flex-col gap-6">
                            <div class="flex items-center gap-2 justify-between">
                                <p-avatar image="https://www.primefaces.org/cdn/primevue/images/landing/apps/avatar8.png" class="w-9/12 h-9" shape="circle" />
                                <div class="flex-1">
                            ...
                            <div class="flex items-center gap-2 justify-between">
                                <p-avatar image="https://www.primefaces.org/cdn/primevue/images/landing/apps/avatar13.jpg" class="w-9/12 h-9" shape="circle" />
                                <div class="flex-1">
                            ...
                            <div class="flex items-center gap-2 justify-between">
                                <p-avatar image="https://www.primefaces.org/cdn/primevue/images/landing/apps/avatar12.jpg" class="w-9/12 h-9" shape="circle" />
                                <div class="flex-1">
            ...
            <div class="flex-1 flex flex-wrap gap-12">
                ...
                <div class="flex-1 border border-surface rounded-3xl p-12 flex flex-col gap-12">
                    ...
                    <div>
                        ...
                        <div class="rounded-full px-6 py-1 bg-surface-200 dark:bg-surface-800 w-fit mx-auto mt-6 text-color text-lg leading-relaxed">u*******m&#64;gmail.com</div>
                    </div>
