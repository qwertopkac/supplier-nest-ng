...
import { DesignerService } from '../../../core/service/designerservice';
...
@Component({
    ...
    template: `
        <div class="flex-1 h-full overflow-y-auto pb-0.5">
            <div class="flex flex-wrap gap-6 items-start justify-between p-1">
                <div class="flex-1">
            ...
            <div class="mt-6 flex flex-wrap gap-12 items-center justify-between p-1">
                                        ...
                                        <div class="flex items-center">
                                            <i
                                                ...
                                                [ngClass]="{
                                                    ...
                                                    'pi-ethereum bg-surface-950 text-surface-0 dark:bg-surface-0 dark:text-surface-950 w-7/12 h-7 rounded-full !flex items-center justify-center': item.coin !== 'eth'
                                                }"
                                            ></i>
                                        </div>
                                    </td>
                                ...
                                <ng-template #label>
                                    <div class="flex flex-col gap-12 mt-6">
                                        <ng-container *ngFor="let val of metersData; let index = index">
                                            <div class="flex items-center gap-2">
                                                <div class="w-2/12 h-2 rounded-full" [ngStyle]="{ backgroundColor: val.color }"></div>
