        ...
        <ul class="list-none p-0 m-0">
            <li class="flex flex-col md:flex-row md:items-center md:justify-between mb-12">
                ...
                <div class="mt-2 md:mt-0 flex items-center">
                    ...
                    <span class="text-orange-500 ml-6 font-medium">%50</span>
                </div>
            </li>
            <li class="flex flex-col md:flex-row md:items-center md:justify-between mb-12">
                <div>
                ...
                <div class="mt-2 md:mt-0 ml-0 md:ml-20 flex items-center">
                    ...
                    <span class="text-cyan-500 ml-6 font-medium">%16</span>
                </div>
            </li>
            <li class="flex flex-col md:flex-row md:items-center md:justify-between mb-12">
                <div>
                ...
                <div class="mt-2 md:mt-0 ml-0 md:ml-20 flex items-center">
                    ...
                    <span class="text-pink-500 ml-6 font-medium">%67</span>
                </div>
            </li>
            <li class="flex flex-col md:flex-row md:items-center md:justify-between mb-12">
                <div>
                ...
                <div class="mt-2 md:mt-0 ml-0 md:ml-20 flex items-center">
                    ...
                    <span class="text-primary ml-6 font-medium">%35</span>
                </div>
            </li>
            <li class="flex flex-col md:flex-row md:items-center md:justify-between mb-12">
                <div>
                ...
                <div class="mt-2 md:mt-0 ml-0 md:ml-20 flex items-center">
                    ...
                    <span class="text-purple-500 ml-6 font-medium">%75</span>
                </div>
            </li>
            <li class="flex flex-col md:flex-row md:items-center md:justify-between mb-12">
                <div>
                ...
                <div class="mt-2 md:mt-0 ml-0 md:ml-20 flex items-center">
                    ...
                    <span class="text-teal-500 ml-6 font-medium">%40</span>
                </div>
            </li>
        </ul>
    </div>`
