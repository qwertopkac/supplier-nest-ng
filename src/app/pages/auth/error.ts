                ...
                <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, rgba(233, 30, 99, 0.4) 10%, rgba(33, 150, 243, 0) 30%)">
                    <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-20 sm:px-20 flex flex-col items-center" style="border-radius: 53px">
                        <div class="gap-6 flex flex-col items-center">
                            ...
                            <span class="text-muted-color mb-20">Requested resource is not available.</span>
                            <img src="https://primefaces.org/cdn/templates/sakai/auth/asset-error.svg" alt="Error" class="mb-20" width="80%" />
